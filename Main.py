from dao import ProductCategoryDAO, ProductTypeDAO, PurchaseOrderDAO, PurchaseOrderItemDAO, SalesOrderDAO, SupplierDAO
from utility import *
from domain import *
from dao import *
from bo import *
...
def menu_details(ch):
    if(ch==1):
        ...
        print("%-20s %-20s %-20s %-20s"%( "Id", "Product Name", "Quantity", "Unit Price"))
        ...
        print("%-20s %-20s %-20s %-20s %-20s"%("Id" , "Name", "Mobile Number", "Email-id", "Address"))
        ...
        print("%-20s %-20s %-20s %-20s %-20s %-20s %-20s"%("Id" , "Name", "Username", "Mobile Number", "Email-id", "Address","Role"))
